...
namespace snippets {
     ...
     * Bitmask class
     *
     * \details This class provides a way to manage a bitmask with a specific number of bits.
     *
    ...
    private:
         ...
         * Masks for each bit
         * 
         * \details This array contains the masks for each bit in the bitmask. It is generated
         *          during compile time to avoid recalculating the masks every time they are needed.
         */
